...
function Weather() {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-slate-900 text-slate-100 p-4 font-sans">
      ...
      {/* CARD: Darker gray with a subtle border */}
      <div className="bg-slate-800 border border-slate-700 p-8 rounded-2xl shadow-xl w-full max-w-md text-center">
        ...
        <div className="flex gap-2 mb-8">
          ...
          <button
            ...
            className="bg-amber-500 hover:bg-amber-600 text-slate-900 font-bold py-3 px-6 rounded-lg transition duration-200"
          >
            Search
          </button>
        </div>
        ...
        {weatherData && (
          <div className="animate-fade-in-up">
            ...
            <div className="text-8xl font-bold my-6 text-white tracking-tighter">
